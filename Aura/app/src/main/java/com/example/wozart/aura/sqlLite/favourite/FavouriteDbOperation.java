package com.example.wozart.aura.sqlLite.favourite;
...
import com.example.wozart.aura.tab.favouriteTab.Favourites;
import com.example.wozart.aura.utilities.Constant;

import java.util.ArrayList;

import static com.example.wozart.aura.sqlLite.favourite.FavouriteContract.FavouriteEntry.DEVICE_NAME;
import static com.example.wozart.aura.sqlLite.favourite.FavouriteContract.FavouriteEntry.HOME_NAME;
import static com.example.wozart.aura.sqlLite.favourite.FavouriteContract.FavouriteEntry.LOAD_NAME;
import static com.example.wozart.aura.sqlLite.favourite.FavouriteContract.FavouriteEntry.ROOM_NAME;
import static com.example.wozart.aura.sqlLite.favourite.FavouriteContract.FavouriteEntry.TABLE_NAME;
import static com.example.wozart.aura.utilities.Constant.CRUD_FAVOURITE;
import static com.example.wozart.aura.utilities.Constant.UPDATE_LOAD_NAME;
